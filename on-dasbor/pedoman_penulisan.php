...
?>
			<div class="col-md-12">
				<h2>Pedoman Penulisan Skripsi</h2>
				<hr>
				<p>
					<b>DOWNLOAD Pedoman Penulisan skripsi disini !</b>
					<a href='save_pedoman_penulisan.php' target="_self" class='btn btn-success glyphicon glyphicon-save' title='Save Pedoman Penulisan'>
					</a>
				</p>
				<hr />
				</div>
