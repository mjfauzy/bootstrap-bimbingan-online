...
?>
			<div class="col-md-12">
				...
				<hr>
				<p>
					<a href='#' class='btn btn-primary glyphicon glyphicon-plus' data-target='#ModalAdd' data-toggle='modal' title='Tambah Data Mahasiswa'></a>
				</p>
				<p>
					<table id="dataMahasiswa" class="table table-bordered table-hover table-striped">
						...
						<tbody>
							<?php
							$result = mysqli_query($connect,"SELECT * FROM tb_mahasiswa ORDER BY nama");
							if ($result) {
									...
									while ($row = $result->fetch_object()) {
										...
										<tr>
											...
											<td class="text-center">
												<a href='#' class='open_modal_edit btn btn-success glyphicon glyphicon-pencil' data-target='#ModalEdit' data-toggle='modal' id="<?php echo $row->nim; ?>" title='Edit Data Mahasiswa'></a>
												<a href='#' class='btn btn-danger glyphicon glyphicon-trash' data-target='#ModalDelete' data-toggle='modal' onclick="confirm_delete('proses_hapus_mahasiswa.php?nim=<?php echo $row->nim; ?>');" title='Hapus Data Mahasiswa'></a>
											</td>
										</tr>
							<?php
									}
