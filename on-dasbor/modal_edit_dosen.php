...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="proses_update_dosen.php" name="modal_popup" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group" style="padding-bottom: 20px;">
				  ...
				  <input type="hidden" name="nidn"  class="form-control" value="<?php echo $row->nidn; ?>" />
                </div>
